...
const imageMap: Record<BlogImageKey, string> = {
	...
	cheatsPackage: finalsImages.espWallhack,
	playerEsp: finalsImages.playerEsp,
	rebootFight: finalsImages.aimbotCombat,
	battleRoyaleCombat: finalsImages.cheatsCombat,
	battleRoyaleIslandMap: finalsImages.espWallhack,
};
...
export function getBlogSitemapEntriesForLocale(locale: LocaleCode) {
	...
	for (const post of blogPosts) {
		...
		const isProductPost = /THE FINALS Hacks|Aimbot|ESP|Comparisons/i.test(post.category);
		entries.push({
