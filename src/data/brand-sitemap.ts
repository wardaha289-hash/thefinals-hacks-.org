...
const defaultImages: BrandSitemapImage[] = [
	{
		src: '/images/the-finals-hacks-esp.webp',
		title: 'thefinals hacks esp',
		caption: 'thefinals hacks esp wallhack',
	},
	{
		src: '/images/the-finals-hacks-wallhack.webp',
		title: 'thefinals hacks wallhack',
		caption: 'thefinals hacks wallhack esp',
	},
	{
		src: '/images/the-finals-hacks-aimbot.webp',
		title: 'thefinals hacks aimbot',
		caption: 'thefinals hacks aimbot soft aim',
	},
	{
		src: '/images/the-finals-hacks-aimbot-view.webp',
		title: 'thefinals hacks aimbot',
		caption: 'thefinals hacks aimbot view',
	},
	{
		src: '/images/the-finals-hacks-radar.webp',
		title: 'thefinals hacks radar',
		caption: 'thefinals hacks radar hack',
	},
	{
		src: '/images/the-finals-hacks-raid.webp',
		title: 'thefinals hacks',
		caption: 'thefinals hacks in raid',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	...
	undetected: { title: '{primaryKeyword}', caption: 'Status notes for {primaryKeyword} after patches' },
