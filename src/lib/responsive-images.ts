...
export const heroResponsive: ResponsiveWidth[] = [
	{ src: '/images/the-finals-hacks-hero-640w.webp', width: 640 },
	{ src: '/images/the-finals-hacks-hero-1024w.webp', width: 1024 },
];

export const heroDesktopResponsive: ResponsiveWidth[] = heroResponsive;

/** Default LCP src — mid ladder WebP (~56KB). */
export const heroSrc = '/images/the-finals-hacks-hero-1024w.webp';
