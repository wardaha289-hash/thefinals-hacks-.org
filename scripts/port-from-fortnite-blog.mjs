#!/usr/bin/env node
/**
 * Ports the 8 posts from ../finals-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'finals-blog', 'src', 'content', 'posts');
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'finals intel'],
...
const file = `/* Auto-generated by scripts/port-from-finals-blog.mjs — do not edit by hand. */
