...
const DEFAULT_SITEMAP_IMAGES = [
	...
	{
		src: '/images/the-finals-hacks-combat.webp',
...
export function validateBrandPayload(body) {
	...
	const logo = assetPath(b.logo ?? '/images/the-finals-hacks-logo.webp');
	const logoRaster = assetPath(b.logoRaster ?? '/images/the-finals-hacks-logo.png');
	const defaultOgImage = assetPath(b.defaultOgImage ?? '/images/the-finals-hacks-combat.webp');
	const heroImage = assetPath(b.heroImage ?? '/images/the-finals-hacks-hero-banner.webp');
