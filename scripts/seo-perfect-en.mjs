...
const replacements = [
	// Wrong publishers in prose (EXT.activision already links to escapefromfinals.com)
	['published by ${EXT.activision}', 'published by Battlestate Games (${EXT.finals})'],
	['from ${EXT.activision}', 'from ${EXT.finals}'],
	['via ${EXT.activision}', 'via ${EXT.finals}'],
	['belong with ${EXT.activision}', 'belong with Battlestate Games'],
	['${EXT.activision} terms', 'Battlestate Games terms'],
	['${EXT.activision} season updates', '${EXT.finals} wipe and map updates'],
	...
	['vehicles, loot', 'players, teams, and bots, loot'],
	['notice vehicles before they push your position', 'spot players and teams before they push your angle'],
	...
	['players, loot, and vehicles', 'players, teams, and bots, and loot'],
	['players, loot, vehicles', 'players, teams, and bots, loot'],
	...
	['thefinals hacks & thefinals hacks', 'thefinals hacks'],
	[
		'covering both thefinals hacks and thefinals hacks search intent',
		'covering both “thefinals hacks” and “THE FINALS cheats” search intent',
	],
	[
		'also searched as thefinals hacks and finals cheat.',
		'built for THE FINALS on Windows PC.',
	],
	[
		'THE FINALS hacks vs thefinals hacks — same stack, clear pages',
		'How this THE FINALS hacks pillar fits nearby pages',
	],
	[
		'Searchers use thefinals hacks and thefinals hacks interchangeably. This pillar focuses on hacks language; the',
	...
	['best THE FINALS hacks guide', 'THE FINALS hacks pillar'],
	['best THE FINALS hacks checklist', 'THE FINALS hacks checklist'],
	['best THE FINALS hacks', 'THE FINALS hacks'],
	[
