...
const assetsDir =
	'C:/Users/Aman/.cursor/projects/c-Users-Aman-finalshacks/assets';
...
const USER_SCREENSHOTS = [
	...
	},
	{
		...
		file: 'the-finals-hacks-combat.webp',
	},
];
...
const REMOVE_PREFIXES = [
	'finals-battle-royale-combat',
	'finals-extract-fight',
	'the-finals-hacks-aimbot',
	'the-finals-hacks-cover',
	'the-finals-hacks-esp-wallhack',
	'the-finals-hacks-hero',
	'the-finals-hacks-logo',
	'the-finals-hacks-package',
	'finals-header-art',
	'finals-loadout-builder',
	'finals-player-esp',
	'finals-scav-run-combat',
	'finals-scav-run-mode',
	'finals-squad-fight',
	'finals-verdansk-map',
];

async function removeOldTHE FINALSImages() {
...
await removeOldTHE FINALSImages();
